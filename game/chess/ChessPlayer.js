...
var ChessPlayer = (function() {
	...
	ChessPlayer.prototype.gameOver = function(victoryStatus) {
		...
		if(player.userInfo) {
			switch(this.victory) {
				case VICTORY_STATUS.win:
					let winCount = player.userInfo.get("winCount");
					winCount++;
					player.userInfo.set('winCount', winCount);
					player.userInfo.save();
					break;
				case VICTORY_STATUS.lose:
					let loseCount = player.userInfo.get("loseCount");
					loseCount++;
					player.userInfo.set('loseCount', loseCount);
					player.userInfo.save();
					break;
				case VICTORY_STATUS.draw:
					let drawCount = player.userInfo.get("drawCount");
					drawCount++;
					player.userInfo.set('drawCount', drawCount);
					player.userInfo.save();
					break;
			}
		}
